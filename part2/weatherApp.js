...
ef = new WeatherData({value:12, subtype:'west'}, new Date(2000, 8, 1, 12,0,0), 'Horsens', 'temp', 'INT')
b =  new WeatherData({value:-112}, new Date(2020, 9, 6, 12,0,0), 'Kolding', 'temp', 'INT')
c =  new WeatherData({value:32}, new Date(2020, 9, 7, 12,0,0), 'Horsens', 'temp', 'US')
...
let from = new Date(2020, 9, 1, 0,0,0)
let to = new Date(2021, 11, 19, 0,0,0)

let di = new DateInterval(from, to)

console.log(matches(10,45,c))

wp = new WeatherPrediction(10,25,ef)
